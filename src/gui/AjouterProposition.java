     ...
     submit.addActionListener((e)->{
       ...
       if(nom.getText() == "" ||mail.getText()== ""){
         Dialog.show("veuillez vérifier les donnees ","","annuler","ok");
           ...
           iDialog.dispose();
           refreshTheme();
                     mailingEvent.sendEmail("chayma.hamrouni@esprit.tn", "Ajout Proposition", "Par cet email nous vous informons qu'une proposition est bien reçue de la part d'un client!");
